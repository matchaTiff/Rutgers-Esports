        ...
        <>
            ...
            <div className="aboutSection">
                <div className="aboutInfo">
                    <h2>About</h2>
                    <h4>Rutgers Esports Discord is <em>the</em> main hub for all things Rutgers Esports!</h4>
                    <p> {/* You can change this to whatever idrc */}
                        <ul>
                ...
                <iframe className="discord-widget" title="Rutgers Esports" src="https://discord.com/widget?id=143013824679641088&theme=dark" width="350" height="350" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
            </div>

            <div className="servers section-container">
                <h2 class="new-section">Server Directory</h2>
            ...
            <div className="rutgers-kun-section text-center section-container">
                ...
                <div className="social-links d-flex justify-content-center">
                    <div className="horizontal-group justify-content-center">
                        <a href="https://github.com/sriRacha21/Rutgers-kun3/blob/master/README.md">
                            <img src="/Pictures/ThirdParty/github-logo.svg" alt="Contribute"></img>
                        </a>
                        <p>Contribute on GitHub</p>
                    </div>
                    <div className="horizontal-group">
                        <a href="https://discord.gg/YDEpNDV">
                            <img src="/Pictures/ThirdParty/discord-logo.svg" alt="Join the development server!" width="120px"></img>
                        </a>
                    ...
                    <div className="horizontal-group">
                        <a href="https://discordapp.com/api/oauth2/authorize?client_id=291355097919913985&permissions=0&scope=bot">
                            <img src="/Pictures/Branding/Rutgers-kun/chibi_rutgers-kun.png" alt="Add me!" width="120px"></img>
                        </a>
